...
@section('content')
    ...
    <div class="card shadow-lg rounded card p-2">
        <div class="card-header" id="#atas">
            <span class="fs-4 fw-700">Data Perusahaan</span>
            <a href="{{ route('perusahaan.create') }}" class="btn btn-sm btn-primary float-end "><svg
                            ...
                            @foreach ($perusahaans as $perusahaan)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <!--begin::Thumbnail-->
                                            <img src="{{ asset($perusahaan->image_perusahaan) }}"
                                    ...
                                    <td>
                                        <form action="{{ route('perusahaan.destroy', $perusahaan->id) }}" method="post">
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalCenter{{ $perusahaan->id }}"><svg
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="modalCenter{{ $perusahaan->id }}" tabindex="-1"
                                                aria-hidden="true">
